...
export function LatticeLogo({ size = 26 }: { size?: number }) {
  // 3x3 dot grid matching Reference 1 exactly:
  // Row 1: Blue, Red, Red
  // Row 2: Blue, Blue, Yellow
  // Row 3: Blue, Sky Blue, Green
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      {/* Row 1 */}
      <circle cx="5" cy="5" r="3.4" fill="#1A73E8" />
      <circle cx="14" cy="5" r="3.4" fill="#EB4335" />
      <circle cx="23" cy="5" r="3.4" fill="#F23B3F" />

      {/* Row 2 */}
      <circle cx="5" cy="14" r="3.4" fill="#1A73E8" />
      <circle cx="14" cy="14" r="3.4" fill="#1A73E8" />
      <circle cx="23" cy="14" r="3.4" fill="#FBBC05" />

      {/* Row 3 */}
      <circle cx="5" cy="23" r="3.4" fill="#1A73E8" />
      <circle cx="14" cy="23" r="3.4" fill="#5A9DFB" />
      <circle cx="23" cy="23" r="3.4" fill="#34A853" />
    </svg>
  );
}

export function HistoryIcon({ size = 20, color = "currentColor" }: { size?: number; color?: string }) {
  return (
...
export function SettingsIcon({ size = 20, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function AppsGridIcon({ size = 20, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <rect x="4" y="4" width="3.5" height="3.5" rx="0.8" fill={color} />
      <rect x="10.25" y="4" width="3.5" height="3.5" rx="0.8" fill={color} />
      <rect x="16.5" y="4" width="3.5" height="3.5" rx="0.8" fill={color} />
      <rect x="4" y="10.25" width="3.5" height="3.5" rx="0.8" fill={color} />
      <rect x="10.25" y="10.25" width="3.5" height="3.5" rx="0.8" fill={color} />
      <rect x="16.5" y="10.25" width="3.5" height="3.5" rx="0.8" fill={color} />
      <rect x="4" y="16.5" width="3.5" height="3.5" rx="0.8" fill={color} />
      <rect x="10.25" y="16.5" width="3.5" height="3.5" rx="0.8" fill={color} />
      <rect x="16.5" y="16.5" width="3.5" height="3.5" rx="0.8" fill={color} />
    </svg>
  );
}
...
export function CopyIcon({ size = 18, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function SwapIcon({ size = 18, color = "currentColor" }: { size?: number; color?: string }) {
  return (
...
export function SwapHorizontalIcon({ size = 18, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function TuneIcon({ size = 18, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function ArrowRightIcon({ size = 16, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function DocumentIcon({ size = 20, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function ListCheckIcon({ size = 20, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function PencilIcon({ size = 20, color = "currentColor" }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
